...
if (isset($_GET['hsk']) && $_GET['hsk'] != "") {
    ...
    $goback = new moodle_url('/mod/book/view.php', ['id' => 15, 'chapterid' => 19]);
    ?>
    ...
    <div id="flashcard" class="slideshow-container">
        ...
        foreach ($flashcardData as $key => $value) {
            ...
            if (file_exists($mp4File)) {
                $answer = preg_replace('/[0-9]+/', '', $value[1]->content);
                ?>
                <div class="flip-box form-group mySlides fadeslide">
                    ...
                    <input type="button" data-id="<?php echo $key; ?>" data-answer="<?php echo $answer; ?>" data-rotate="no" data-next="no" class="flashcardsubmit btn btn-primary" name="Submit" value="Submit" />
                </div>
    ...
    <div class="container">
        <form action="" method="get">
            ...
            <input type="hidden" name="chapterid" value="19" />
            <div class="row">
                <div class="col-sm-12">
